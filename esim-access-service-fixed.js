...
module.exports = ({ strapi }) => ({
    ...
    async createOrder(productId) {
        ...
        // Use configured package code or fallback to a known valid test code (CKH006 - Europe 3GB)
        // In production, every product MUST have a valid esimAccessPackageCode
        const packageCode = product.esimAccessPackageCode || 'CKH006';
