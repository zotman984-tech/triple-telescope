        ...
        try {
            ...
            for (const pkg of packages) {
                ...
                const productData = {
                    ...
                    region: pkg.locationCode?.includes(',') ? pkg.locationCode.split(',')[0] : pkg.locationCode,
                    country: pkg.location || pkg.locationCode,
                    dataAmountGB: pkg.volume ? (pkg.volume / 1073741824).toFixed(2) : null, // Convert bytes to GB
